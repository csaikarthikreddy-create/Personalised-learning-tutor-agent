...
class ReplayEngineer(FeatureEngineer):
    ...
    def replay(self, data_file: str = None):
        ...
        for i, tick in enumerate(ticks):
            ...
            if features:
                ...
                if self.feature_count % 100 == 0:
                    logger.info(f"Processed {i+1}/{len(ticks)} ticks, generated {self.feature_count} features")
        ...
        logger.info(f"Replay complete. Generated {self.feature_count} features from {len(ticks)} ticks.")
